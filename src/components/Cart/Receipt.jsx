export const Receipt = ({id, data, setBasket, setGoBack}) => {
  ...
  return(
    <div className='bg-green-400 rounded-lg p-6 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4/5 max-w-2xl text-white'>
     ...
     <p className='text-lg text-left font-bold my-2'>Direccion: {data.buyer.address}</p>
      ...
      <ol>
        {data.items.map((i) => {
          return(
            <li key={i.id} className='flex gap-4 my-2'>
